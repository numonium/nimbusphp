...
abstract class Uglify
{
    ...
    public static final function installed()
    {
        ...
        $ret = exec(static::$location . static::$exists_check, $output, $return);
        
        
        var_dump('@@$$',exec('echo $PATH',$out,$ret2),$out,$ret2,static::$location . static::$exists_check,$ret,$output,$return);
        die();
